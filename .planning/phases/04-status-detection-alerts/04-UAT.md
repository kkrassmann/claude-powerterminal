...
result: issue
reported: "das highlight ist bisschen zu dezent und wird übersehen, funktionalität pass"
severity: cosmetic
...
result: pass
note: Fixed white-screen-on-reload bug (will-navigate intercept for file:// URLs)
...
- White screen on Ctrl+R reload (file:// URL lost index.html suffix) — FIXED in electron/main.ts

## Gaps

- truth: "WAITING tile glow is clearly visible and draws attention"
  status: deferred
  reason: "User reported: das highlight ist bisschen zu dezent und wird übersehen, funktionalität pass"
  severity: cosmetic
  test: 4
