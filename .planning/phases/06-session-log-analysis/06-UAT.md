...
number: 1
name: Analysis button visible in header
expected: |
  App header zeigt einen "Analyse"-Button zwischen Mute-Button und LAN-URL. Button hat Border und reagiert auf Hover.
